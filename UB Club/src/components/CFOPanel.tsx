...
export const CFOPanel: React.FC<CFOPanelProps> = ({
  ...
  // Multi-Currency DCC simulator state (Req #9)
    ...
    <div className="space-y-8 max-w-5xl mx-auto py-4 font-mono text-zinc-100">
        ...
        <div className="bg-zinc-900/60 border border-zinc-800/80 rounded p-8 space-y-8 backdrop-blur-md">
          <div className="border-b border-zinc-800 pb-6">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs uppercase text-emerald-400 font-bold tracking-widest">Pillar 2: Global Financial Engine</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <form onSubmit={handleDispatchInvoice} className="p-6 bg-zinc-950/50 border border-zinc-800 rounded space-y-4">
              <h3 className="text-xs text-zinc-300 uppercase font-bold tracking-wider flex items-center gap-2">
                ...
                Automated Weekly Invoicing Engine (Req #12)
              </h3>
            ...
            {/* Escrow Reserve & Dispute Management Engine (Req #14) */}
            <div className="p-6 bg-zinc-950/50 border border-zinc-800 rounded space-y-4">
              <h3 className="text-xs text-zinc-300 uppercase font-bold tracking-wider flex items-center gap-2">
                <Coins size={16} className="text-yellow-500" />
                Escrow Reserve & Dispute Engine (Req #14)
              </h3>
      ...
      {activeTab === 'global_remit' && (
        <div className="bg-zinc-900/60 border border-zinc-800/80 rounded p-8 space-y-8 backdrop-blur-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Multi-Currency Stripe DCC Simulator (Req #9) */}
            <div className="p-6 bg-zinc-950/50 border border-zinc-800 rounded space-y-4">
              <h3 className="text-xs text-zinc-300 uppercase font-bold tracking-wider">Multi-Currency Stripe DCC (Req #9)</h3>
            ...
            {/* Skydo API Virtual Accounts (Req #11) */}
            <div className="p-6 bg-zinc-950/50 border border-zinc-800 rounded space-y-4">
              <h3 className="text-xs text-zinc-300 uppercase font-bold tracking-wider">Skydo Virtual Routing Details (Req #11)</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Automated Bank Validation - Penny Drops (Req #10) */}
            <form onSubmit={handleRunPennyDrop} className="p-6 bg-zinc-950/50 border border-zinc-800 rounded space-y-4">
              <h3 className="text-xs text-zinc-300 uppercase font-bold tracking-wider">Automated Penny Drop Validation (Req #10)</h3>
            ...
            {/* Sunday Payout Automation Scheduler (Req #13) */}
            <div className="p-6 bg-zinc-950/50 border border-zinc-800 rounded space-y-4">
              <h3 className="text-xs text-zinc-300 uppercase font-bold tracking-wider flex items-center gap-2">
        ...
        <div className="bg-zinc-900/60 border border-zinc-800/80 rounded p-8 space-y-8 backdrop-blur-md">
          <div className="border-b border-zinc-800 pb-6">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs uppercase text-emerald-400 font-bold tracking-widest">Pillar 1: Cross-Border Regulatory Compliance</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* GST LUT Filing Card (Req #1) */}
            <div className="p-6 bg-zinc-950/50 border border-zinc-800 rounded space-y-4">
              <div className="flex justify-between items-center">
                <h3 className="text-xs text-zinc-300 uppercase font-bold tracking-wider">GST LUT Export Status (Req #1)</h3>
            ...
            {/* DTAA Form 10F & TRC Manager (Req #6) */}
            <div className="p-6 bg-zinc-950/50 border border-zinc-800 rounded space-y-4">
              <h3 className="text-xs text-zinc-300 uppercase font-bold tracking-wider">DTAA Form 10F & TRC Repository (Req #6)</h3>
        ...
        <div className="bg-zinc-900/60 border border-zinc-800/80 rounded p-8 space-y-8 backdrop-blur-md">
          <div className="border-b border-zinc-800 pb-6">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs uppercase text-emerald-400 font-bold tracking-widest">Pillar 2: Sub-contractor TDS & Travel Expenses</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Sub-contractor Tax Deducted at Source (TDS) (Req #15) */}
            <div className="p-6 bg-zinc-950/50 border border-zinc-800 rounded space-y-4">
              <h3 className="text-xs text-zinc-300 uppercase font-bold tracking-wider">Sub-contractor TDS (Sec 194J) (Req #15)</h3>
            ...
            {/* Dynamic Travel & Cost Reimbursement OCR Scanner (Req #16) */}
            <div className="p-6 bg-zinc-950/50 border border-zinc-800 rounded space-y-4">
              <h3 className="text-xs text-zinc-300 uppercase font-bold tracking-wider">Dynamic Travel OCR Scanner (Req #16)</h3>
