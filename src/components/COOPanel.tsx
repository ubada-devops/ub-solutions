...
export const COOPanel: React.FC<COOPanelProps> = ({
  ...
  // Custom Freelancer NDA Generator state
  const [newNdaAlias, setNewNdaAlias] = useState('');

  // Zero-Trust Cold Outreach State
    ...
    <div className="space-y-8 max-w-5xl mx-auto py-4 font-mono text-zinc-100">
      ...
      <div className="bg-zinc-900/60 border border-zinc-800/80 rounded p-8 space-y-8 shadow-2xl backdrop-blur-md">
          ...
          <>
            <div className="border-b border-zinc-800 pb-6">
              <div className="flex items-center gap-2.5 mb-2">
                ...
                <span className="text-xs uppercase font-bold tracking-widest text-emerald-400 font-mono">Operations Command Gate supply</span>
              </div>
            ...
            {/* IP Proxy Staging Isolation Controller */}
            <div className="pt-6 border-t border-zinc-850 flex flex-col md:flex-row items-center justify-between gap-4 bg-zinc-950/40 p-6 border border-zinc-800 rounded">
              <div className="space-y-1">
                <span className="text-xs text-zinc-300 uppercase font-bold flex items-center gap-1.5">
                  ...
                  IP Proxy Staging Sandbox Isolation
                </span>
        ...
        {activeSubTab === 'legal_contracts' && (
          <>
            <div className="border-b border-zinc-800 pb-6">
              <span className="text-xs uppercase font-bold tracking-widest text-emerald-400">Legal Compliance</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* Standardized Zoho Sign Templates */}
              <div className="p-6 bg-zinc-950/50 border border-zinc-800 rounded space-y-4">
                <h3 className="text-xs text-zinc-300 uppercase font-bold tracking-wider">Standardized Zoho Sign Templates</h3>
              ...
              {/* Custom NDA Engine for Freelancers & IEC Code */}
              <div className="space-y-6">
                <form onSubmit={handleGenerateFreelancerNda} className="p-6 bg-zinc-950/50 border border-zinc-800 rounded space-y-4">
                  <h3 className="text-xs text-zinc-300 uppercase font-bold tracking-wider">Custom NDA Engine for Freelancers</h3>
                ...
                {/* IEC Registration Tracker */}
                <div className="p-6 bg-zinc-950/50 border border-zinc-800 rounded space-y-3">
                  <h3 className="text-xs text-zinc-300 uppercase font-bold tracking-wider">IEC Registration & DGFT Export</h3>
        ...
        {activeSubTab === 'recruitment_affiliates' && (
          <>
            <div className="border-b border-zinc-800 pb-6">
              <span className="text-xs uppercase font-bold tracking-widest text-emerald-400">Growth & Recruitment</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* Affiliate Partner Commission Dashboard */}
              <div className="p-6 bg-zinc-950/50 border border-zinc-800 rounded space-y-4">
                <h3 className="text-xs text-zinc-300 uppercase font-bold tracking-wider">Affiliate Partner Commissions</h3>
              ...
              {/* Institute Recruitment Pipeline */}
              <div className="p-6 bg-zinc-950/50 border border-zinc-800 rounded space-y-4">
                <h3 className="text-xs text-zinc-300 uppercase font-bold tracking-wider">Institute Recruitment Pipeline</h3>
        ...
        {activeSubTab === 'outreach' && (
          <>
            <div className="border-b border-zinc-800 pb-6">
              <span className="text-xs uppercase font-bold tracking-widest text-emerald-400">Go-To-Market Scaling</span>
              <h1 className="text-2xl font-bold text-white tracking-tight">Zero-Trust Cold Outreach Campaigns</h1>
              <p className="text-sm text-zinc-400 mt-1">High-intensity outbound campaigns emphasizing absolute IP isolation and strict anonymous security of UB Solutions.</p>
            </div>

            <div className="p-6 bg-zinc-950/50 border border-zinc-800 rounded space-y-4">
              <h3 className="text-xs text-zinc-300 uppercase font-bold tracking-wider">Outbound Campaign Builder</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-zinc-900 border border-zinc-850 rounded text-xs space-y-2">
                  ...
                  <p className="text-zinc-300 italic">
                    ...
                    <br/><br/>
                    Hi Team, UB Solutions provides elite L6+ Indian software engineers operating under cryptographically masked aliases, hardware HSM vaults, and total IP isolation..."
                  </p>
                </div>
