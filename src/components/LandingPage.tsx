...
export const LandingPage: React.FC<LandingPageProps> = ({ onNavigateToLogin }) => {
  ...
  const testimonials = [
    { name: 'Ravi K.', role: 'Gym Owner, FitZone', text: 'UB Solutions built our entire booking platform in 3 weeks. Our online memberships doubled.' },
    { name: 'Sarah M.', role: 'CEO, TechBridge Inc.', text: 'Their AI automation cut our customer support response time by 80%. Incredible team.' },
    { name: 'Ahmed J.', role: 'Marketing Director', text: 'The digital marketing team delivered 5x ROAS within the first month. Data-driven and relentless.' },
  ];
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-mono antialiased overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-24 sm:pt-40 sm:pb-32 px-4 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tighter text-white leading-[1.05] mb-6">
            We Build
          ...
          <p className="text-base sm:text-lg text-zinc-400 max-w-2xl mx-auto leading-relaxed mb-10 font-sans">
            ...
            From gym owners to global enterprises.
          </p>
          ...
          {/* Tech Stack Strip */}
          <div className="mt-16 flex flex-wrap justify-center gap-6 text-[9px] text-zinc-600 uppercase tracking-widest font-bold">
        ...
        <div className="max-w-6xl mx-auto px-4 py-12 sm:py-16 grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            <div key={i} className="text-center group">
              <div className="flex justify-center mb-3 text-emerald-500/60 group-hover:text-emerald-400 transition-colors">
                {stat.icon}
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {services.map((service, i) => (
              <div
                ...
                className={`group relative p-6 border rounded-xl transition-all duration-300 cursor-pointer overflow-hidden ${
                  activeService === i
              ...
              >
                ...
                {activeService === i && (
                  <div className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl ${service.gradient} opacity-[0.04] blur-2xl rounded-full`} />
                )}
                ...
                <p className="text-xs text-zinc-500 leading-relaxed mb-4 font-sans">{service.desc}</p>
      ...
      {/* ═══════════════════ HOW IT WORKS ═══════════════════ */}
      <section className="py-20 px-4 border-y border-zinc-900/60 bg-zinc-900/10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="relative group">
                <div className="p-6 border border-zinc-900 rounded-xl bg-zinc-950/60 hover:border-zinc-800 transition-all h-full">
                  <div className="text-[10px] text-emerald-500 font-bold tracking-widest mb-4">{item.step}</div>
                ...
                {i < 3 && (
                  <div className="hidden lg:block absolute top-1/2 -right-3 text-zinc-800">
                    <ChevronRight size={14} />
                  </div>
                )}
              </div>
